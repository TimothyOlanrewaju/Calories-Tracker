class CalorieTracker{
    ...
    addWorkout(workout){
        ...
        this._displayAddedWorkouts(workout)
        this._render();
    }
    removeMeal(id){
    ...
    loadItems(){
        this._meals.forEach(meal => this._displayAddedMeals(meal))
        this._workouts.forEach(workout => this._displayAddedWorkouts(workout))
    }
...
class Storage{
    ...
    //static methods for calories limit
    ...
    //static methods for total calories
...
class App{
    ...
    _loadEventListeners(){
        ...
        document.getElementById('reset').addEventListener('click',this._resetItems.bind(this))
    ...
    _newItem(type, e){
        ...
        if(name.value === '' || calories.value === ''){
            alert('Please enter the values required')
            return;
        }
        ...
        //collapse input fields after submit
    ...
    _resetItems(){
        ...
        document.getElementById('meal-workouts').innerHTML = '';
